...
To ease into our multivariate analysis, let's first take a look at the ratio 
of `fare` to `nsmiles` (bivariate), which could be considered fare value or cost
per mile for fares (split by trip length):
...
With the above plot of fare value value being non-linear, it makes me want to
